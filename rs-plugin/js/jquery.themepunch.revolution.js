										...
										try{
												...
												if (jQuery(this).hasClass('video-js') && addedvid==0) {
													...
													if (loadit) {
														...
														jQuery('head').append('<link rel="stylesheet" type="text/css" href="../../public_html/rs-plugin/js/'+opt.videoJsPath+'video-js.min.css" media="screen" />');
		...
		********************************/
		...
		function createThumbs(container,opt) {
			...
			container.find('>ul:first >li').each(function(i) {
							...
							bullets.append('<div class="bullet thumb" style="width:'+opt.thumbWidth+'px;height:'+opt.thumbHeight+'px;"><img src="../../public_html/rs-plugin/js/'+src+'"></div>');
		...
		function prepareSlides(container,opt) {
			...
			container.find('>ul:first >li').each(function(j) {
				...
				if (li.data('link')!=undefined) {
					...
					if (link=="slide") {
						...
						li.append('<div class="tp-caption sft slidelink" style="z-index:'+zindex+';" data-x="0" data-y="0" data-linktoslide="'+linktoslide+'" data-start="0"><a target="'+target+'" href="../../public_html/rs-plugin/js/'+link+'"><div></div></a></div>');
			...
			container.find('>ul:first >li >img').each(function(j) {
				...
				if (isIE(8)) {
					...
					pari.find('.tp-bgimg').append('<img class="ieeightfallbackimage defaultimg" src="../../public_html/rs-plugin/js/'+src+'" style="width:100%">');
				...
				if (vorh == "horizontal") {
					...
					for (var i=0;i<opt.slots;i++) {
							...
							if (isIE(8)) {
							   ...
							   sh.find('.slot ').last().find('.slotslide').append('<img class="ieeightfallbackimage" src="../../public_html/rs-plugin/js/'+imgsrc+'" style="width:100%">');
				...
				for (var j=0;j<opt.slots;j++) {
					...
					for (var i=0;i<opt.slots;i++) 	{
						...
						if (isIE(8)) {
							...
							sh.find('.slot ').last().find('.slotslide').append('<img src="../../public_html/rs-plugin/js/'+imgsrc+'">');
